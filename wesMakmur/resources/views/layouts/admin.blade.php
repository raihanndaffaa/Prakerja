            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">TIK Health</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Detail Kegiatan</span>
                    </li>
                    <!-- Kategori -->
                    ...
                    <li class="menu-item {{ Request::is('admin/barang') ? 'active' : '' }}">
                        <a href="{{ url('admin/barang') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bxl-product-hunt"></i>
